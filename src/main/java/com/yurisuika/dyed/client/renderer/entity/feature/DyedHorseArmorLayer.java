package com.yurisuika.dyed.client.renderer.entity.feature;
...
@OnlyIn(Dist.CLIENT)
public class DyedHorseArmorLayer extends RenderLayer<Horse, HorseModel<Horse>> {
    ...
    public DyedHorseArmorLayer(RenderLayerParent<Horse, HorseModel<Horse>> p_174496_, EntityModelSet p_174497_) {
        super(p_174496_);
    ...
    public void render(PoseStack p_117032_, MultiBufferSource p_117033_, int p_117034_, Horse p_117035_, float p_117036_, float p_117037_, float p_117038_, float p_117039_, float p_117040_, float p_117041_) {
        this.renderHorseArmor(p_117032_, p_117033_, p_117034_, p_117035_, p_117036_, p_117037_, p_117038_, p_117039_, p_117040_, p_117041_);
    }

    private void renderHorseArmor(PoseStack p_117119_, MultiBufferSource p_117120_, int light, Horse p_117035_, float p_117036_, float p_117037_, float p_117038_, float p_117039_, float p_117040_, float p_117041_) {
        ...
        if (itemStack.getItem() instanceof HorseArmorItem horseArmorItem) {
            ...
            if (horseArmorItem instanceof DyeableHorseArmorItem) {
                ...
                this.renderHorseArmorParts(p_117119_, p_117120_, light, horseArmorItem, n, o, p, null);
                this.renderHorseArmorParts(p_117119_, p_117120_, light, horseArmorItem, 1.0F, 1.0F, 1.0F, "overlay");
            } else {
                this.renderHorseArmorParts(p_117119_, p_117120_, light, horseArmorItem, 1.0F, 1.0F, 1.0F, null);
            }
        }
    }
    ...
    private void renderHorseArmorParts(PoseStack p_117119_, MultiBufferSource p_117120_, int light, HorseArmorItem name, float red, float green, float blue, @Nullable String overlay) {
        ...
        model.renderToBuffer(p_117119_, vertexConsumer, light, OverlayTexture.NO_OVERLAY, red, green, blue, 1.0F);
    }
